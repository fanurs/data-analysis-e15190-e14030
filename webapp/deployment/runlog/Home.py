...
st.set_page_config(page_title='Run log · E15190-E14030', layout='wide')
"""# Run log"""



##### Read in run log from the database
df_elog = pd.read_hdf('elog_runs_filtered.h5')
...
df_elog = df_elog.drop(columns=['index', 'trigger_rate'])
